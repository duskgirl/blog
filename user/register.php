...
function register () {
  ...
  $url = "http://127.0.0.1:3000/blog/user/activeacount.php?email={$email}&token={$token}";    
   ...
   if($result == 1) {
     header('Location:/blog/user/sendmail-success.php?register=1');
        ...
        <div class="container">
          <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 content">
            ...
            <div class="alert alert-success success">
              <?php echo $success_message; ?><strong><a href="/blog/user/login.php"> 点此登录</a></strong> 
            </div>
            <?php endif ?>
            <p class="skip_login">已有账户,<a href="/blog/user/login.php">直接登录<span class="fa fa-angle-double-right"></span></a></p>
          </div>
        </div>
      </div>
    </div>
          ...
          email: {
            ...
            validators: {
              ...
              remote: {
                ...
                // 提示消息
                message: '当前邮箱已存在，请直接去<a href="/blog/user/login.php">登录</a>吧',
